...
public class FF14NewsUtils {
    ...
    private static final String DEFAULT_CATEGORY_CODES = "8324,8325,8326,8327,5309,5310,5311,5312,5313";
    ...
    private JSONObject fetchPage(int pageIndex, int pageSize) throws IOException {
        String categoryCodes = systemConfigService.getString("ff14.news.category-codes", DEFAULT_CATEGORY_CODES);
