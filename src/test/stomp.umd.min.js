!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : t(
        ((e =
          "undefined" != typeof globalThis ? globalThis : e || self).StompJs =
          {})
      );
})(this, function (e) {
  "use strict";
  ...
  class n {
    constructor(e) {
      ...
      (this.command = t),
        ...
        i
          ...
          : ((this._body = n || ""), (this.isBinaryBody = !1)),
    ...
    serialize() {
      ...
      return this.isBinaryBody
        ? n.toUnit8Array(e, this._binaryBody).buffer
        : e + this._body + s;
    }
    serializeCmdAndHeaders() {
      ...
      for (const t of Object.keys(this.headers || {})) {
        ...
        "CONNECTED" !== this.command
          ? e.push(`${t}:${n.hdrValueEscape(`${s}`)}`)
          : e.push(`${t}:${s}`);
      }
      return (
        (this.isBinaryBody ||
  ...
  class i {
    ...
    parseChunk(e, t = !1) {
      ...
      if (
        ((s =
          "string" == typeof e ? this._encoder.encode(e) : new Uint8Array(e)),
        t && 0 !== s[s.length - 1])
      ) {
    ...
    _setupCollectBody() {
      const e = this._results.headers.filter(
        (e) => "content-length" === e[0]
      )[0];
      e
  ...
  (e.StompSocketState = void 0),
    ((o = e.StompSocketState = e.StompSocketState || (e.StompSocketState = {}))[
      (o.CONNECTING = 0)
    ] = "CONNECTING"),
    (o[(o.OPEN = 1)] = "OPEN"),
    ...
    ((c = e.ActivationState = e.ActivationState || (e.ActivationState = {}))[
      (c.ACTIVE = 0)
    ] = "ACTIVE"),
  ...
  class a {
      ...
      (this._client = e),
        ...
        (this._serverFrameHandlers = {
          ...
          RECEIPT: (e) => {
            ...
            t
              ? (t(e), delete this._receiptWatchers[e.headers["receipt-id"]])
      ...
      if (0 !== this.heartbeatOutgoing && 0 !== i) {
        ...
        this.debug(`send PING every ${s}ms`),
          (this._pinger = setInterval(() => {
            this._webSocket.readyState === e.StompSocketState.OPEN &&
              (this._webSocket.send(t), this.debug(">>> PING"));
          }, s));
      }
    ...
    forceDisconnect() {
      this._webSocket &&
        ((this._webSocket.readyState !== e.StompSocketState.CONNECTING &&
          this._webSocket.readyState !== e.StompSocketState.OPEN) ||
          this._closeOrDiscardWebsocket());
    }
    _closeWebsocket() {
    ...
    discardWebsocket() {
      var e, t;
      "function" != typeof this._webSocket.terminate &&
        ((e = this._webSocket),
        (t = (e) => this.debug(e)),
        (e.terminate = function () {
          ...
          (this.onclose = (e) => {
            ...
            t(
              `Discarded socket (#${i})  closed after ${s}ms, with code/reason: ${e.code}/${e.reason}`
            );
          }),
            this.close(),
            o?.call(e, {
    ...
    nack(e, t, s = {}) {
      return (
        ...
        this._connectedVersion === r.V1_2 ? (s.id = e) : (s["message-id"] = e),
        (s.subscription = t),
        this._transmit({ command: "NACK", headers: s })
      );
    }
  }
  class h {
    ...
    activate() {
      const t = () => {
        this.active
          ...
          : (this._changeState(e.ActivationState.ACTIVE), this._connect());
      };
      this.state === e.ActivationState.DEACTIVATING
      ...
      (this._stompHandler = new a(this, t, {
        ...
        onWebSocketClose: (t) => {
          (this._stompHandler = void 0),
            this.state === e.ActivationState.DEACTIVATING &&
              this._changeState(e.ActivationState.INACTIVE),
    ...
    async deactivate(t = {}) {
      ...
      if (this.state === e.ActivationState.INACTIVE)
        return (
          this.debug("Already INACTIVE, nothing more to do"), Promise.resolve()
        );
      if (
        (this._changeState(e.ActivationState.DEACTIVATING),
        this._reconnector &&
          (clearTimeout(this._reconnector), (this._reconnector = void 0)),
        !this._stompHandler ||
          this.webSocket.readyState === e.StompSocketState.CLOSED)
      )
        return this._changeState(e.ActivationState.INACTIVE), Promise.resolve();
      {
  ...
  class l extends h {
    ...
    _parseConnect(...e) {
      ...
      else if (6 === e.length) [i.login, i.passcode, s, n, t, i.host] = e;
      else [i.login, i.passcode, s, n, t] = e;
      return [i, s, n, t];
    }
    connect(...e) {
